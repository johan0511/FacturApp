        ...
        <div className="contp">
          <div className="textp">
            <p className="pcuerp">
              ¿Que es FacturApp? <br />
              <br />
              FacturApp. es el software definitivo para simplificar tus procesos
              de facturación, control de inventario y registro de ventas. Con
              una interfaz amigable y de fácil uso, FacturApp. te permite
              automatizar tus tareas diarias y enfocarte en lo que realmente
