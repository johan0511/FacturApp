...
export function Factura() {
  ...
  const [metodosPago, setMetodosPago] = useState(["De contado", "A cuotas"]);
  ...
  const handleMetodoPago = (metodo) => {
    if (metodo === "A cuotas") {
      ...
      setNumeroCuotas("seleccione el numero de numero de cuotas");
    }
  };
        ...
        <div className="container">
                ...
                <div className="card-body">
                  ...
                  <div className="button-container">
                    ...
                    <Button
                      ...
                      onClick={() => console.log("consultar clicked")}
                    >
                      Consultar cliente
                    </Button>
                  </div>
                ...
                <div className="card-body">
                  ...
                  <div>
                    <select
                      ...
                      name="metodoPago"
                      id="metodoPago"
                      onChange={(e) => handleMetodoPago(e.target.value)}
                    >
          ...
          <div className="row mt-4">
            <div className="col-md-12">
              <div className="card">
                <div className="card-body">
                  <h4 className="card-title">Seleccione el vehiculo</h4>
                  <div className="row">
                    <br />
                    <br />
                    <div className="col-md-4">
                      ...
                      >
                        <option
                          label="Seleccione el vehiculo a vender"
                          value=""
                        ></option>
