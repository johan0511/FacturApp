...
class App extends Component {
  state = {
    ...
    form: {
      ...
      Precio: "",
      cantidadAgregar: "",
      tipoProducto: "", // Nuevo campo para almacenar el tipo de producto
    },
    productosAgrupados: [],
    currentPage: 1,
    productsPerPage: 6,
  ...
  handleChange = (e) => {
    ...
    // Si el nombre es 'Descripcion', actualiza el estado en consecuencia
    if (name === "Descripcion") {
      const cantidad = parseInt(value);
      estado = cantidad > 0 ? "Disponible" : "Agotado";
    }

    // Si el nombre es 'tipoProducto', actualiza el formulario según el tipo seleccionado
    if (name === "tipoProducto") {
      if (value === "Nueva") {
        // Si el tipo es 'Nueva', establece el kilometraje en 0
        ...
        // Si el tipo es 'Segunda mano', habilita el campo de kilometraje
        this.setState((prevState) => ({
          form: {
            ...prevState.form,
            [name]: value,
      ...
      // Para otros campos, actualiza el formulario normalmente
      this.setState({
        form: {
          ...this.state.form,
          [name]: value,
        ...
        <Modal isOpen={this.state.modalInsertar}>
          ...
          <ModalBody>
            <div className="form-group">
              ...
              />
              <br />
              <label htmlFor="Nombre_categoria">MODELO</label>
              <input
                className="form-control"
                type="text"
              ...
              />
              <br />
              <label htmlFor="Proveedor">CILINDRAJE</label>
              <input
                className="form-control"
                type="text"
                name="Proveedor"
              ...
              />
              <br />
              <label htmlFor="Descripcion">AÑO</label>
              <input
                className="form-control"
                type="number"
                name="Descripcion"
